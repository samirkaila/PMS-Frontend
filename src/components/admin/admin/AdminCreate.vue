	...
	<div class="main_wapper-inner main_wapper-inner-v2">
		...
		<div class="admin-deshboard sidebar">
			<div class="top_add_btn">
				<router-link  :to="{name:'admin.admins'}" class="h-button task_modal_btnd">Back</router-link>
			</div>
			...
			<div class="create-user">
				<div class="task_form">
					...
					<div class="form_add_tasks">
						<form @submit.prevent="saveUser" ref="form" id="users_save_form">
							<div class="row">
								...
								<div class="col-xl-4 col-md-6">
									<div class="input_wrap">
										...
										<input class="input_field" type="password" placeholder="Password" v-model="this.user.password" required>
									</div>
								</div>
								<div class="col-xl-4 col-md-6">
									<div class="input_wrap">
