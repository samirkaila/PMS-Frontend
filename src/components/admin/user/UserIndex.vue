	...
	<div class="main_wapper-inner main_wapper-inner-v2">
		...
		<div class="admin-deshboard sidebar">
			...
			<div class="top_add_btn">
				<router-link  :to="{name:'user.create'}" class="h-button"><span><img :src="`${publicPath}images/btn-plus-icon.svg`" alt="" ></span>Add User</router-link>
			</div>
						...
						<tr v-for=" (user, index) in users" v-bind:index="index" v-bind:key="user.id">
							...
							<td>
								<div class="action-box">
									<router-link class="action-btn edit" :to="{name:'user.edit',params: { id: user._id }}" ><img  :src="`${publicPath}images/icon-edit.svg`" alt=""></router-link>
